		...
		<div class="container-fluid mx-auto px-5 d-flex">
			...
			<div class="navbar-item" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item ">
						<button class="btn log btn-dark px-4 my-1 text-white nova_square" data-bs-toggle="modal"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="col d-flex justify-content-center align-items-center">
						...
						<h5 class="text-center ms-2 nova_square">Welcome To Apex Assembly</h5>
					</div>
				...
				<div class="modal-body">
					...
					<form action="<?= base_url('auth/register'); ?>" method="post">
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="registerNama" name="registerNama"
						...
						<div class="mb-3">
							<label for="registerNotlp" class="form-label">No Telepon</label>
							<input type="number" class="form-control" id="registerNotlp" name="registerNotlp"
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-6 px-5 d-flex justify-content-center align-items-center custom ">
					<div class="col px-5">
						<h1 class="text-white my-2 px-5">Welcome</h1>
						...
						<a href="" class="btn btn-outline-light mx-5 px-5 fs-6">Detail</a>
					</div>
				</div>
				<div class="col-md-6 px-5 d-flex justify-content-center align-items-center custom ">
				...
				<div class="row d-flex justify-content-center">
					<div class="card mx-3 py-3 gradient-custom2" style="width : 18rem">
						...
						<div class="card-body">
							...
							<a href="#" class="btn btn-light text-black">Go Check >>></a>
						</div>
					</div>
